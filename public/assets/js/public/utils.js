define(function (require, exports, module) {
    ...
    function previewPhoto(e) {
        ...
        if ($list.length === 0) {
            ...
            $list.find('[data-role="photoItem"]').each(function (_, item) {
                var url = $(item).attr('data-original') || $(item).find('img').attr('data-original') || '', ext = getFileExt(url), thumb = url.indexOf('/assets') > -1 ? url : url + '!medium.640';
    ...
    var Utils = window['Utils'] = {
        ...
        mLoading: mLoading,
        mNotice: mNotice,
        bindPreviewPhoto: bindPreviewPhoto,
