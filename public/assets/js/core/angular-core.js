            ...
            return {
                request: function (request) {
                    var $data = function (data) {
                        if (IGrow.User.schoolid && !/\/api\/1.1b\/school\/(get|student\/get|teacher\/get|parent\/get|people\/get)$/i.test(request.url)) {
                ...
                responseError: function (response) {
                    if (response.data && response.data.code == '10020002') { location.href = 'http://auth.igrow.cn/auth/login?go=' + encodeURIComponent(location.href); }
        ...
        function (http) {
            ...
            var $resource = function (url, options, actions) {
                ...
                resourse = {
                    ...
                    wxcreate: function (data, successCallback, failCallback, always) {
                        var url = this.url + '/wxcreate',
                            data = data || {};
